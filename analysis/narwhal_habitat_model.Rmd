...
## here, I define the freeze up date as the day when sea ice > 90%
...
## join both datasets
mdl_data_b4freeze_pooled <- rbind(model_data_open_water2018, model_data_open_water2019)
...
```{r fit best model}
# model with 'device' variable
mdl_best <- glm(narwhal ~ glacier+glacier_length+runoff+salt_deep+ice_cover_percent,
