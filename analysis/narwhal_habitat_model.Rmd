...
# runoff
runoff_kong <- read.csv(paste(path,"runoff/kongoscar_runoff_1D.csv",sep=''))%>% mutate(site="kong")
runoff_rink <- read.csv(paste(path,"runoff/rink_runoff_1D.csv",sep=''))%>% mutate(site="rink")
runoff_sver <- read.csv(paste(path,"runoff/sverdrup_runoff_1D.csv",sep=''))%>% mutate(site="sver")
